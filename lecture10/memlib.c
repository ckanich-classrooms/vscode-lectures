...
/* hoisted from config.h */
/*
 * Maximum heap size in bytes
 */
#define MAX_HEAP (20*(1<<20))  /* 20 MB */

/* hoisted from csapp.c */
...
/*
 * mem_heap_lo - return address of the first usable heap header
 */
void *mem_heap_lo()
{
    return (void *)mem_heap + 12;
}

/* 
 * mem_heap_hi - return address of last valid byte of heap
 */
void *mem_heap_hi()
{
